...
The logical pages represented by a physical NAND flash page are "paired" in that they must be written together[^picoli20]<sup>,</sup>[^linuxnand]. 
...
[^linuxnand]: https://elinux.org/images/7/70/NAND_Subsystem.pdf
