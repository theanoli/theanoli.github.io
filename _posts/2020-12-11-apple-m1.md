...
ETA: In terms of clock cycles, RISC instructions take a single cycle to complete, whereas CISC instructions may take more than one. 
As a result of all this, CISC chips are more complex than RISC chips but the software built on top of CISC chips can be simpler, and CISC chips need less memory to accomplish the same task[^armbirth]. 
...
[^armbirth] <https://arstechnica.com/features/2020/12/how-an-obscure-british-pc-maker-invented-arm-and-changed-the-world/>
